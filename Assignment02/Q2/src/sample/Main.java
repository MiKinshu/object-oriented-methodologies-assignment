...
// }
    ...
    class FromV {
        ...
        public void Dijkstra(LinkedList<FromV> graphL, String fromv, String tov, HashMap<String,Integer> vertexno, HashMap<Integer,String> map, LinkedList<Vertex> vertexLinkedList) throws QueryNotFoundException, InvalidArgumentsException {
            try {
                map.clear();
                vertexno.clear();
    ...
    public class Main extends Application {
        ...
        void AddVertex(String Vname, String Vxa, String Vya) throws InvalidArgumentsException, AlreadyExistsException, NumberFormatException{
        ...
        void SearchVertex(String Vname) throws QueryNotFoundException, InvalidArgumentsException {
            if(Vname==null||Vname.equals(""))
                throw new InvalidArgumentsException();
            if(!vertexno.containsKey(Vname))
                throw new QueryNotFoundException();
        ...
        void DeleteVertex(String Vname) throws QueryNotFoundException{
            if(!vertexno.containsKey(Vname))
                throw new QueryNotFoundException();
            else {
                int key = Collections.binarySearch(vertexLinkedList, new Vertex(Vname, 0.0, 0.0), new Comparator<Vertex>() {
        ...
        void AddEdge(String FromV, String ToV, String weight1)throws QueryNotFoundException, InvalidArgumentsException, AlreadyExistsException{
        ...
        void SearchEdge(String FromVS, String ToVS) throws QueryNotFoundException{
        ...
        void DeleteEdge(String FromVS, String ToVS) throws QueryNotFoundException{
            int fkey=Collections.binarySearch(FromVertexLL, new FromV(FromVS), new Comparator<FromV>() {
                @Override
                public int compare(FromV o1, FromV o2) {
                    return o1.getName().compareTo(o2.getName());
        ...
        void ModifyEdge(String FromVS, String ToVS, String weight1) throws InvalidArgumentsException, QueryNotFoundException {
        ...
        public void start(Stage primaryStage) throws Exception{
            ...
            BTNAddVertex.setOnMouseClicked(new EventHandler<MouseEvent>() {
                ...
                public void handle(MouseEvent mouseEvent) {
                    ...
                    try {
                        String Vx = (TFVertexX.getText());
                        String Vy = (TFVertexY.getText());
                        ...
                        alert.setTitle(null);
                        alert.setHeaderText(null);
                        alert.setContentText("This vertex already exists.\n Use edit vertex to edit this.");
                        alert.showAndWait();
                    }
                    TFVertexName.clear();
                    TFVertexX.clear();
            ...
            BTNSearchEdge.setOnMouseClicked(new EventHandler<MouseEvent>() {
                ...
                public void handle(MouseEvent mouseEvent) {
                    ...
                    try {
                        ...
                        alert.setTitle(null);
                        alert.setHeaderText(null);
                        alert.setContentText("No Such edge found.\nEnter Valid Arguments.");
                        alert.showAndWait();                    }
                }
            });
            ...
            BTNModifyEdge.setOnMouseClicked(new EventHandler<MouseEvent>() {
                ...
                public void handle(MouseEvent mouseEvent) {
                    ...
                    String weight = (TFWeightM.getText());
                    try {
            ...
            BTNPrintPath.setOnMouseClicked(new EventHandler<MouseEvent>() {
                ...
                public void handle(MouseEvent mouseEvent) {
                    ...
                    try {
                        ...
                        alert.setTitle(null);
                        alert.setHeaderText(null);
                        alert.setContentText("No Such vertices found.\nEnter Valid Arguments.");
                        alert.showAndWait();
                    } catch (InvalidArgumentsException e) {
                        Alert alert = new Alert(Alert.AlertType.ERROR);
                        alert.setTitle(null);
                        alert.setHeaderText(null);
                        alert.setContentText("Given vertices not found.");
                        alert.showAndWait();                          }
                }
            });
                ...
                public void handle(MouseEvent mouseEvent) {
                    ...
                    try {
                        ...
                        for(int i=0;i<NoOfVertices;i++){
                            ...
                            AddVertex(words[0],(words[1]),(words[2]));
                        }
