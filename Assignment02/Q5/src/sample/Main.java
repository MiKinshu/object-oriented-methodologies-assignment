        ...
        scene.setOnKeyPressed(new EventHandler<KeyEvent>() {//add functionality for deleting corrosponding edges.
            ...
            public void handle(KeyEvent keyEvent) {
                ...
                if(keyEvent.getCode()==KeyCode.D){
                    td.setHeaderText("Enter number of Dijkstra Queries");
                    td.setContentText(null);
                    td.showAndWait();
                    int noq=1;
                    try{
                        noq=Integer.parseInt(td.getEditor().getText());
                        ...
                        for(int m=0;m<noq;m++) {
                            ...
                            td.setHeaderText("Enter Symbol");
                            td.setContentText("1. for Square.\n2. for  Plus\n3. for Cross\n4. for Triangle");
                            td.showAndWait();
                            int user_choice=Integer.parseInt(td.getEditor().getText());
                            ...
                            try {
                                ...
                                if (output.equals(fromv + " ")) {
                                    ...
                                    Shape circlet=new Circle();
                                    switch (user_choice){
                                        case 1: {
                                            circlet=new Rectangle(0,0,20,20);
                                        ...
                                        case 2: {
                                            circlet=new Polygon();
                                            circlet.setFill(Color.DARKBLUE);
                                            ((Polygon)circlet).getPoints().addAll(0.0, 0.0,
                                                    8.0, 0.0,
                                                    8.0, 8.0,
                                                    12.0, 8.0,
                                                    12.0, 0.0,
                                        ...
                                        case 3: {
                                            ...
                                            ((Polygon)circlet).getPoints().addAll(0.0, 0.0,
                                                    ...
                                                    8.00,-4.00,
                                                    0.00,-4.00);
                                            circlet.setRotate(45);
                                            circlet.setFill(Color.GREEN);
                                            break;
                                        }
                                        case 4: {
                                            circlet=new Polygon();
                                            ((Polygon)circlet).getPoints().addAll(0.0, 0.0,
                                                    11.4, 20.0,
                                                    20.0, 0.0);
                                            circlet.setFill(Color.TRANSPARENT);
                                            circlet.setStroke(Color.YELLOW);
                                            circlet.setStrokeWidth(3);
                                            break;
                                        }
                                        default:{
                                            throw new InvalidArgumentsException();
